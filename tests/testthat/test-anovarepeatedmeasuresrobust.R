...
test_that("Robust RM ANOVA (mixed bootstrap) main table matches", {
  ...
  jaspTools::expect_equal_tables(table,
    list("facGender", 0.939698492462312, 0.00997274507466552,
         "RMfactor", 0.306532663316583, -0.267677592474227, -0.591308697087234,
         0.0904522613065326, "facGender <unicode> RMfactor" #,
         #-0.0678837817234042,  -0.293653970373737, -0.777416051522222, -0.0812632082983334
         ))
})
