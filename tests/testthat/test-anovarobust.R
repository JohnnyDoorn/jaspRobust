...
test_that("Robust ANOVA (bootstrap one-way) main table matches", {
  ...
  table <- results[["results"]][["postHocContainer"]][["collection"]][["postHocContainer_facFive"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(-0.6419588225, 0.9075399455, 1, 2, -0.00431226266666668, 0.904522613065327,
                                      -1.28975437083333, 0.356706252, 1, 3, -0.48246449425, 0.150753768844221,
                                      -0.80271150675, 0.94352920275, 1, 4, -0.0118785009166667, 0.984924623115578,
                                      -1.26692523, 0.767382042416667, 1, 5, -0.27550904525, 0.422110552763819,
                                      -1.30702959666667, 0.2738854095, 2, 3, -0.478152231583333, 0.0804020100502513,
                                      -0.975893972333333, 0.690094472583333, 2, 4, -0.00756623825000002,
                                      0.994974874371859, -1.06066981441667, 0.660924184833333, 2,
                                      5, -0.271196782583333, 0.361809045226131, -0.267415558166667,
                                      1.40070958125, 3, 4, 0.470585993333333, 0.110552763819096, -0.545286826416667,
                                      1.07866859166667, 3, 5, 0.206955449, 0.482412060301508, -1.13965573125,
                                      0.83219886425, 4, 5, -0.263630544333333, 0.311557788944724
                                 ))
})
