...
test_that("Robust ANOVA (bootstrap one-way) main table matches", {
  ...
  jaspTools::expect_equal_tables(table,
    list(-0.6419588225, 0.9075399455, 1, 2, -0.00431226266666668, 0.904522613065327,
         ...
         1.40070958125, 3, 4, 0.470585993333333, 0.110552763819096,
         -0.545286826416667, 1.07866859166667, 3, 5, 0.206955449, 0.482412060301508,
         -1.13965573125, 0.83219886425, 4, 5, -0.263630544333333, 0.311557788944724))
})
