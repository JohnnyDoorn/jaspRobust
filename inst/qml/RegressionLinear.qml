...
Form
{
	...
	Section
	{
		...
		DropDown
		{
			...
			info: qsTr("Select the estimation method. OLS uses ordinary least squares. M-estimation uses iteratively reweighted least squares with a robust weight function that downweights outlying observations.")
			values:
			[
				{ label: qsTr("OLS"),                    value: "ols"      },
				{ label: qsTr("M-estimation (Huber)"),    value: "huber"    },
